class UserStocksController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_stock.save
        format.html { redirect_to my_portfolio_path, notice: "Stock #{@user_stock.stock.name} was successfully added." }
        #format.html { redirect_to my_portfolio_path, notice: "Stock #{@user_stock.stock.ticker} was successfully added." }
        #format.json { render :show, status: :created, location: @user_stock }
      else
        format.html { redirect_to my_portfolio_path, notice: "#{@user_stock.errors.full_messages}" }
